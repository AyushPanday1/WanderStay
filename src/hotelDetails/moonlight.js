    ...
    <div>
      ...
      <div className="hotelContainer">
        ...
        <div className="hotelWrapper">
          <h1 className="hotelTitle">Hotel Moonlight.</h1>
          ...
          <span className="hotelPriceHighlight">
            Book a stay over $211 at this property and get a free airport taxi
          </span>
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">
                Located a 5-minute walk from St. Florian's Gate in Krakow, Hotel
                Moonlight has accommodations with air conditioning and
